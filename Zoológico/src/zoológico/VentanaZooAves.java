...
public class VentanaZooAves {
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1_2_4_2_5 = new JLabel("N\u00B0 Plumas: ");
		...
		JLabel lblNewLabel_1_2_4_2_6 = new JLabel("Color Pico: ");
		...
		JLabel lblNewLabel_1_2_4_2_6_1 = new JLabel("Garras: ");
	...
	private class SwingAction extends AbstractAction {
		...
		public void mostrar() {
			String matriz [][] = new String[15][listaAves.size()];
			
			for (int i = 0; i < listaAves.size(); i++) {
				
				matriz[0][i]=listaAves.get(i).getNombre();
				matriz[1][i]=Integer.toString(listaAves.get(i).getEdad());
				matriz[2][i]=Integer.toString(listaAves.get(i).getPeso());
				matriz[3][i]=Integer.toString(listaAves.get(i).getNumeroDePatas());
				matriz[4][i]=listaAves.get(i).getTamaño();
				matriz[5][i]=listaAves.get(i).getMedio();
				matriz[6][i]=listaAves.get(i).getGenero();
				matriz[7][i]=listaAves.get(i).getAlimentacion();
				matriz[8][i]=listaAves.get(i).getColor();
				matriz[9][i]=listaAves.get(i).getTamaño(); //pelo
				matriz[10][i]=Integer.toString(listaAves.get(i).getNumeroDePlumas()); 
				matriz[11][i]=listaAves.get(i).getColorDePico();
				matriz[12][i]=Integer.toString(listaAves.get(i).getNumeroDePatas()); //garras
