...
public class VentanaZooAnfibios {
	...
	private class SwingAction extends AbstractAction {
		...
		public void mostrar() {
			String matriz [][] = new String[12][listaAnfibios.size()];
			
			for (int i = 0; i < listaAnfibios.size(); i++) {
				
				matriz[0][i]=listaAnfibios.get(i).getNombre();
				matriz[1][i]=Integer.toString(listaAnfibios.get(i).getEdad());
				matriz[2][i]=Integer.toString(listaAnfibios.get(i).getPeso());
				matriz[3][i]=Integer.toString(listaAnfibios.get(i).getNumeroDePatas());
				matriz[4][i]=listaAnfibios.get(i).getTamaño();
				matriz[5][i]=listaAnfibios.get(i).getMedio();
				matriz[6][i]=listaAnfibios.get(i).getGenero();
				matriz[7][i]=listaAnfibios.get(i).getAlimentacion();
				matriz[8][i]=listaAnfibios.get(i).getColor();
				matriz[9][i]=Integer.toString(listaAnfibios.get(i).getNumeroDePatas()); //pelo
				matriz[10][i]=listaAnfibios.get(i).getTamaño(); 
				matriz[11][i]=listaAnfibios.get(i).getTipoDeRespiracion(); 
				
				} 												
			table.setModel(new DefaultTableModel(
					matriz,
					new String[] {
						"Anfibio 1", "Anfibio 2", "Anfibio 3", "Anfibio 4", "Anfibio 5", "Anfibio 6", "Anfibio 7", "Anfibio 8", "Anfibio 9", "Anfibio 10"
					}
				));
		}
	}
