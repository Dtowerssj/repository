...
public class Reptiles extends AnimalZoo implements MecanismoDeAtaque, MecanismoDeDefensa, FormasDeDesplazarse{
	...
	public Reptiles(int edad, int peso, int numeroDePatas, String nombre,
