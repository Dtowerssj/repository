...
public class VentanaZooPeces {
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1_2_4_2_5 = new JLabel("N\u00B0 de Aletas: ");
		...
		JLabel lblNewLabel_1_2_4_2_6 = new JLabel("N\u00B0 Branquias: ");
		...
		JLabel lblNewLabel_1_2_4_2_6_1 = new JLabel("Cartilaginoso: ");
		...
		JLabel lblNewLabel_1_2_4_2_6_1_1 = new JLabel("Oseo: ");
		lblNewLabel_1_2_4_2_6_1_1.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNewLabel_1_2_4_2_6_1_1.setBounds(0, 270, 84, 16);
		panel.add(lblNewLabel_1_2_4_2_6_1_1);
		
		JLabel lblNewLabel_1_2_4_2_6_1_2 = new JLabel("Escamas: ");
		lblNewLabel_1_2_4_2_6_1_2.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNewLabel_1_2_4_2_6_1_2.setBounds(-2, 288, 84, 16);
		panel.add(lblNewLabel_1_2_4_2_6_1_2);
	...
	private class SwingAction extends AbstractAction {
		...
		public void mostrar() {
			String matriz [][] = new String[15][listaPeces.size()];
			
			for (int i = 0; i < listaPeces.size(); i++) {
				
				matriz[0][i]=listaPeces.get(i).getNombre();
				matriz[1][i]=Integer.toString(listaPeces.get(i).getEdad());
				matriz[2][i]=Integer.toString(listaPeces.get(i).getPeso());
				matriz[3][i]=Integer.toString(listaPeces.get(i).getNumeroDePatas());
				matriz[4][i]=listaPeces.get(i).getTamaño();
				matriz[5][i]=listaPeces.get(i).getMedio();
				matriz[6][i]=listaPeces.get(i).getGenero();
				matriz[7][i]=listaPeces.get(i).getAlimentacion();
				matriz[8][i]=listaPeces.get(i).getColor();
				matriz[9][i]=Integer.toString(listaPeces.get(i).getNumeroDePatas()); //pelo
				matriz[10][i]=Integer.toString(listaPeces.get(i).getNumeroDeAletas()); 
				matriz[11][i]=Integer.toString(listaPeces.get(i).getNumeroDeBranquias()); 
				matriz[12][i]=listaPeces.get(i).getTamaño(); //cartilaginoso
				matriz[13][i]=listaPeces.get(i).getTamaño(); //oseo
				matriz[14][i]=Integer.toString(listaPeces.get(i).getPeso()); //escamas
				
				} 												
			table.setModel(new DefaultTableModel(
					matriz,
					new String[] {
						"Ave 1", "Ave 2", "Ave 3", "Ave 4", "Ave 5", "Ave 6", "Ave 7", "Ave 8", "Ave 9", "Ave 10"
					}
				));
		}
	}
