...
public class VentanaZooReptiles {
	...
	public VentanaZooReptiles() {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				nombre = (table.getValueAt(0, i).toString());
				edad = (table.getValueAt(1, i).toString());
				peso = (table.getValueAt(2, i).toString());
				numeroDePatas = (table.getValueAt(3, i).toString());
				tamaño = (table.getValueAt(4, i).toString());
				medio = (table.getValueAt(5, i).toString());
				genero = (table.getValueAt(6, i).toString());
				alimentacion = (table.getValueAt(7, i).toString());
				color = (table.getValueAt(8, i).toString());
				pelo = (table.getValueAt(9, i).toString());
				caparazon = (table.getValueAt(10, i).toString());
				extremidades = (table.getValueAt(11, i).toString());
				dientes = (table.getValueAt(12, i).toString());
				numeroDeDientes = (table.getValueAt(13, i).toString());
	...
	private void initialize() {
		...
		btnEliminar.setBounds(271, 346, 144, 23);
		...
		public void actionPerformed(ActionEvent e) {
			for (int i = 0; i< listaReptiles.size(); i++) {
				if(nombre==listaReptiles.get(i).getNombre()) {
					listaReptiles.remove(i);
				}
			}
			//Actualizar (funcion mostrar)
			String matriz [][] = new String[15][listaReptiles.size()];
